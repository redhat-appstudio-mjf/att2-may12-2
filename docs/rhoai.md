...
2) Go to the `Data Science Projects` section and access your application's project named `att2-may12-2`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `att2-may12-2-notebook`.
...
5) In the terminal, run `cd att2-may12-2` to navigate to your sample app's directory.
